        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <div class="custom-text-block custom-border-radius-start">
                    <h2 class="text-white mb-3">Développez votre présence en ligne avec CartelPlus Congo</h2>

                    <p class="text-white">Chez CartelPlus, nous faisons bien plus que créer des sites internet — nous bâtissons des expériences numériques uniques, modernes et performantes, conçues pour propulser votre activité dans l’ère digitale.</p>

                    <div class="d-flex mt-4">
                        <div class="counter-thumb"> 
                            <div class="d-flex">
                                <span class="counter-number" data-from="1" data-to="13" data-speed="1000"></span>
                                <span class="counter-number-text">k</span>
                            </div>
                            <a href="<?=URL_VOTRE_SITE_WEB ?>"><span class="counter-text">Démarrer mon projet web </span></a>
                        </div> 
                        ...
                        <div class="counter-thumb">    
                            ...
                            <a href="<?=URL_SERVICE_HEBERGEMENT_WEB ?>"><span class="counter-text">En savoir plus sur l’hébergement</span></a>
                        </div> 
                    </div>
                </div>
            </div>
